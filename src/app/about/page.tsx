...
export default function AboutPage() {
      ...
      <main className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <header className="text-center mb-16">
            ...
            <p className="mt-4 text-xl text-foreground-rgb/70">
        ...
        <div className="rounded-2xl p-8 mb-16 bg-brand-rgb/15 border border-brand-rgb/20">
          <h2 className="text-2xl lg:text-3xl font-bold text-brand mb-4"></h2>
  ...
  <section className="prose max-w-none dark:prose-invert"></section>
